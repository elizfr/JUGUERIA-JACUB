...
function computeIsLeftRtlScrollbars() {
    var el = $('<section><section/></section>')
        .css({
        position: 'absolute',
        top: -1000,
        left: 0,
    ...
    var res = innerEl.offset().left > el.offset().left; // is the inner section shifted to accommodate a left scrollbar?
    el.remove();
    return res;
}
...
// Intelligently sectionides a range (specified by a start/end params) by a duration
function sectionideRangeByDuration(start, end, dur) {
    var months;
...
exports.sectionideRangeByDuration = sectionideRangeByDuration;
// Intelligently sectionides one duration by another
function sectionideDurationByDuration(dur1, dur2) {
    var months1;
    var months2;
...
exports.sectionideDurationByDuration = sectionideDurationByDuration;
...
newMomentProto.time = function (time) {
    ...
    if (time == null) { // getter
        ...
        // We need to set the insectionidual fields.
...
exports.sectionideRangeByDuration = util_1.sectionideRangeByDuration;
exports.sectionideDurationByDuration = util_1.sectionideDurationByDuration;
...
var Class_1 = __webpack_require__(35);
/*
Embodies a section that has potential scrollbars
*/
var Scroller = /** @class */ (function (_super) {
    ...
    Scroller.prototype.renderEl = function () {
        return (this.scrollEl = $('<section class="fc-scroller"></section>'));
    };
...
var EventRenderer = /** @class */ (function () {
    ...
    EventRenderer.prototype.renderFgSegEls = function (segs, disableResizing) {
        ...
        if (segs.length) { // don't build an empty html string
            ...
            // Grab insectionidual elements from the combined HTML string. Use each as the default rendering.
...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    DayTableMixin.prototype.renderHeadHtml = function () {
        ...
        return '' +
            '<section class="fc-row ' + theme.getClass('headerRow') + '">' +
...
var DayGrid = /** @class */ (function (_super) {
    ...
    function DayGrid(view) {
        ...
        // isRigid determines whether the insectionidual rows should ignore the contents and be a constant height.
    ...
    // Generates the HTML for a single row, which is a section that wraps a table.
    ...
    DayGrid.prototype.renderDayRowHtml = function (row, isRigid) {
        ...
        return '' +
            ...
            '</table>' +
            '</section>' +
            '<section class="fc-content-skeleton">' +
            '<table>' +
    ...
    DayGrid.prototype.computeRowLevelLimit = function (row) {
        var rowEl = this.rowEls.eq(row); // the containing "fake" row section
        ...
        var emptyCellsUntil = function (endCol) {
            while (col < endCol) {
                ...
                if (segsBelow.length) {
                    ...
                    moreWrap = $('<section/>').append(moreLink);
                    td.append(moreWrap);
    ...
    DayGrid.prototype.showSegPopover = function (row, col, moreLink, segs) {
        var _this = this;
        var view = this.view;
        var moreWrap = moreLink.parent(); // the <section> wrapper around the <a>
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        var content = $('<section class="fc-header ' + theme.getClass('popoverHeader') + '">' +
            '<span class="fc-close ' + theme.getIconClass('close') + '"></span>' +
            '<span class="fc-title">' +
            util_1.htmlEscape(title) +
            '</span>' +
            '<section class="fc-clear"/>' +
            '</section>' +
            '<section class="fc-body ' + theme.getClass('popoverContent') + '">' +
            '<section class="fc-event-container"></section>' +
            '</section>');
...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        dayGridEl = $('<section class="fc-day-grid" />').appendTo(dayGridContainerEl);
...
var Popover = /** @class */ (function () {
    ...
    Popover.prototype.render = function () {
        ...
        this.el = $('<section class="fc-popover"/>')
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.option = function (name, value) {
        ...
        if (typeof name === 'string') {
            ...
            else { // setter for insectionidual option
                newOptionHash = {};
    ...
    Calendar.prototype.initialRender = function () {
        ...
        this.contentEl = $("<section class='fc-view-container'/>").prependTo(el);
        this.initToolbars();
        this.renderHeader();
        this.renderFooter();
    ...
    Calendar.prototype.renderView = function (viewType) {
        ...
        if (!this.view && viewType) {
            ...
            newView.setElement($("<section class='fc-view fc-" + viewType + "-view' />").appendTo(this.contentEl));
...
var AgendaView = /** @class */ (function (_super) {
    ...
    AgendaView.prototype.renderSkeleton = function () {
        ...
        timeGridEl = $('<section class="fc-time-grid" />').appendTo(timeGridWrapEl);
        this.el.find('.fc-body > tr > td').append(timeGridWrapEl);
        this.timeGrid.headContainerEl = this.el.find('.fc-head-container');
        this.timeGrid.setElement(timeGridEl);
        if (this.dayGrid) {
            this.dayGrid.setElement(this.el.find('.fc-day-grid'));
            // have the day-grid extend it's coordinate area over the <hr> sectioniding the two grids
    ...
    AgendaView.prototype.renderSkeletonHtml = function () {
        ...
        return '' +
            ...
            (this.dayGrid ?
                '<section class="fc-day-grid"/>' +
                    '<hr class="fc-sectionider ' + theme.getClass('widgetHeader') + '"/>' :
                '') +
            '</td>' +
            '</tr>' +
            '</tbody>' +
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.computeLabelInterval = function (slotDuration) {
        ...
        for (i = AGENDA_STOCK_SUB_DURATIONS.length - 1; i >= 0; i--) {
            ...
            slotsPerLabel = util_1.sectionideDurationByDuration(labelInterval, slotDuration);
    ...
    TimeGrid.prototype.renderSkeleton = function () {
        var theme = this.view.calendar.theme;
        this.el.html('<section class="fc-bg"></section>' +
            '<section class="fc-slats"></section>' +
            '<hr class="fc-sectionider ' + theme.getClass('widgetHeader') + '" style="display:none" />');
    ...
    TimeGrid.prototype.renderSlatRowHtml = function () {
        ...
        while (slotTime < dateProfile.maxTime) {
            ...
            isLabeled = util_1.isInt(util_1.sectionideDurationByDuration(slotIterator, this.labelInterval));
            axisHtml =
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        for (i = 0; i < this.colCnt; i++) {
            cellHtml +=
                '<td>' +
                    '<section class="fc-content-col">' +
                    '<section class="fc-event-container fc-helper-container"></section>' +
                    '<section class="fc-event-container"></section>' +
                    '<section class="fc-highlight-container"></section>' +
                    '<section class="fc-bgevent-container"></section>' +
                    '<section class="fc-business-container"></section>' +
                    '</section>' +
                    '</td>';
        }
        skeletonEl = this.contentSkeletonEl = $('<section class="fc-content-skeleton">' +
            '<table>' +
            '<tr>' + cellHtml + '</tr>' +
            '</table>' +
            '</section>');
    ...
    TimeGrid.prototype.renderNowIndicator = function (date) {
        ...
        for (i = 0; i < segs.length; i++) {
            nodes.push($('<section class="fc-now-indicator fc-now-indicator-line"></section>')
                .css('top', top)
                .appendTo(this.colContainerEls.eq(segs[i].col))[0]);
        }
        // render an arrow over the axis
        if (segs.length > 0) { // is the current time in view?
            nodes.push($('<section class="fc-now-indicator fc-now-indicator-arrow"></section>')
                .css('top', top)
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            (isResizableFromStart ?
              '<section class="fc-resizer fc-start-resizer" />' :
              ''
              ) +
            */
            (isResizableFromEnd ?
                '<section class="fc-resizer fc-end-resizer" />' :
                '') +
            '</a>';
    };
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    // Builds the HTML to be used for the default element for an insectionidual segment
...
var DayGridHelperRenderer = /** @class */ (function (_super) {
    ...
    DayGridHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        this.component.rowEls.each(function (row, rowNode) {
            ...
            var skeletonEl = $('<section class="fc-helper-skeleton"><table/></section>'); // will be absolutely positioned
            var skeletonTopEl;
            var skeletonTop;
...
var DayGridFillRenderer = /** @class */ (function (_super) {
    ...
    DayGridFillRenderer.prototype.renderFillRow = function (type, seg) {
        ...
        skeletonEl = $('<section class="fc-' + className + '-skeleton">' +
            '<table><tr/></table>' +
            '</section>');
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderEmptyMessage = function () {
        this.contentEl.html('<section class="fc-list-empty-wrap2">' + // TODO: try less wraps
            '<section class="fc-list-empty-wrap1">' +
            '<section class="fc-list-empty">' +
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.render = function () {
        ...
        if (sections) {
            if (!el) {
                el = this.el = $("<section class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>");
            }
            else {
                el.empty();
            }
    ...
    Toolbar.prototype.renderSection = function (position) {
        ...
        var sectionEl = $('<section class="fc-' + position + '"/>');
